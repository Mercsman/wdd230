...
async function apiFetch2() {
    ...
    const url2 = 'https://api.openweathermap.org/data/2.5/weather?lat=33.15&lon=-117.4&units=imperial&cnt=24&appid=11db6f75b42e50b8f59e0e5ea2f6bea5';
    try{
...
function displayResults2(weatherData) {
    currentTemp2.innerHTML = `<strong>${weatherData.main.temp.toFixed(1)}</strong>`;
    const iconsrc2 = `https://openweathermap.org/img/w/${weatherData.weather[1].icon}.png`;
    const desc2 = weatherData.weather[1].description;
...
async function apiFetch3() {
    ...
    const url3 = 'https://api.openweathermap.org/data/2.5/weather?lat=33.15&lon=-117.4&units=imperial&cnt=24&appid=11db6f75b42e50b8f59e0e5ea2f6bea5';
    try{
...
function displayResults3(weatherData) {
    currentTemp3.innerHTML = `<strong>${weatherData.main.temp.toFixed(2)}</strong>`;
    const iconsrc3 = `https://openweathermap.org/img/w/${weatherData.weather[2].icon}.png`;
    const desc3 = weatherData.weather[2].description;
    humidity3.innerHTML = weatherData.main.humidity;
